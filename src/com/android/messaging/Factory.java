...
public abstract class Factory {
    ...
    public static final int NOT_INSEARCH_MODE = 0;
    public static final int INSEARCH_MODE = 1;
    public static final int BACKSEARCH_MODE = 2;
    ...
    public abstract int getInSearchMode();

    public abstract void setInSearchMode(int inSearchMode);
}
