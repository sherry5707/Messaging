...
import com.android.messaging.ui.conversationlist.FavoriteListActivity;
...
public class UIIntentsImpl extends UIIntents {
    ...
    @Override
    public void launchFavoritesActivity(Context context) {
        final Intent intent = new Intent(context, FavoriteListActivity.class);
        context.startActivity(intent);
    }
}
