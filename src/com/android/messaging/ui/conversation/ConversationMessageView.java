...
public class ConversationMessageView extends FrameLayout implements View.OnClickListener,
    ...
    protected void onFinishInflate() {
        ...
        mFavoriteIcon = findViewById(R.id.sms_favorited);
    }
    ...
    protected void onLayout(final boolean changed, final int left, final int top, final int right,
        ...
        final int iconWidth = mData.getIsOutgoing() ? 0 : mContactIconView.getMeasuredWidth();
    ...
    private void updateViewContent() {
        ...
        if (shouldShowSimplifiedVisualStyle() || mData.getIsOutgoing()) {
        ...
        mFavoriteIcon.setVisibility(mData.isFavorited() ? VISIBLE : GONE);
    }
