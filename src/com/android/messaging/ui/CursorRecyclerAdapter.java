...
public abstract class CursorRecyclerAdapter<VH extends RecyclerView.ViewHolder>
    ...
    /**
     * RGK added for update time sections
     */
    private SectionsSetupListener mSectionsSetupListener;
    ...
    protected void init(final Context context, final Cursor c, int flags) {
    ...
    public Cursor swapCursor(final Cursor newCursor) {
        ...
        if (newCursor != null) {
            ...
            if(mSectionsSetupListener != null){
                mSectionsSetupListener.setupSections();
            }
    ...
    public void setSectionsSetupListener(SectionsSetupListener sectionsSetupListener){
        mSectionsSetupListener = sectionsSetupListener;
    }

    public interface SectionsSetupListener{
        void setupSections();
    }
}
