...
public class ConversationDrawables {
    ...
    private int mTabStripPickerColor;       //MediaPicker's tabstrip background color
    ...
    public int getmTabStripPickerColor() {
        return mTabStripPickerColor;
    }
    ...
    public void updateDrawables() {
        ...
        mTitleColor = resources.getColor(R.color.rgk_toolbar_color);
        mTabStripPickerColor = resources.getColor(R.color.conversation_background);
    }
