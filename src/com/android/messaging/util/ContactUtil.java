...
public class ContactUtil {
    ...
    public static String getGeoDescription(Context context, String number) {
        ...
        com.google.i18n.phonenumbers.geocoding.PhoneNumberOfflineGeocoder geocoder = com.google.i18n.phonenumbers.geocoding.PhoneNumberOfflineGeocoder.getInstance();

        Locale locale = context.getResources().getConfiguration().locale;
        String countryIso = getCurrentCountryIso(context, locale);
        com.google.i18n.phonenumbers.Phonenumber.PhoneNumber pn = null;
        try {
