...
public class MessageData implements Parcelable {
    private static final String[] sProjection = {
        ...
        MessageColumns.FAVORITES,
    };

    private static final String[] sUnreadProjection = {
        MessageColumns.READ,
    };
    ...
    private static final int INDEX_FAVORITES = 19;
    ...
    public static String[] getUnreadProjection() {
        return sUnreadProjection;
    }
    ...
    public void bind(final Cursor cursor) {
        ...
        mIsFavorites = (cursor.getInt(INDEX_FAVORITES) == 1);
    }
    ...
    public void populate(final ContentValues values) {
        ...
        values.put(MessageColumns.FAVORITES, mIsFavorites ? 1 : 0);
    }
    ...
    public SQLiteStatement getInsertStatement(final DatabaseWrapper db) {
        ...
        insert.bindLong(INDEX_FAVORITES, mIsFavorites ? 1 : 0);
        return insert;
    }
    ...
    public void writeToParcel(final Parcel dest, final int flags) {
        ...
        dest.writeInt(mIsFavorites ? 1 : 0);
