...
public class ConversationMessageData {
    ...
    public void bind(final Cursor cursor) {
        ...
        mIsFavorited = cursor.getInt(INDEX_FAVORITES) == 1;
    }
    ...
    public boolean getIsOutgoing() {
        return (mStatus < MessageData.BUGLE_STATUS_FIRST_INCOMING
                && mStatus != MessageData.BUGLE_STATUS_UNKNOWN);
    }
    ...
    private static final String CONVERSATION_MESSAGES_QUERY_PROJECTION_SQL =
            ...
            + DatabaseHelper.MESSAGES_TABLE + '.' + MessageColumns.FAVORITES
            + " as " + ConversationMessageViewColumns.FAVORITES + " ";
    ...
    interface ConversationMessageViewColumns extends BaseColumns {
        ...
        static final String FAVORITES = MessageColumns.FAVORITES;
    }
    ...
    private static final int INDEX_FAVORITES     = sIndexIncrementer++;
    ...
    private static String[] sProjection = {
        ...
        ConversationMessageViewColumns.FAVORITES,
    };
