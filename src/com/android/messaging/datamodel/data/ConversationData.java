...
public class ConversationData extends BindableData {
    ...
    public void save2Favorites(final BindingBase<ConversationData> binding, final String messageId) {
        Assert.isTrue(binding.getData() == this);
        Assert.notNull(messageId);
        SaveFavoritesAction.saveOrDeleteFavorites(messageId, false);
    }

    public void deleteMessageFromFavorites(final BindingBase<ConversationData> binding, final String messageId) {
        Assert.isTrue(binding.getData() == this);
        Assert.notNull(messageId);
        SaveFavoritesAction.saveOrDeleteFavorites(messageId, true);
    }
