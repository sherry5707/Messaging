...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static class ConversationColumns implements BaseColumns {
        ...
        /* If this conversation is top chat */
        public static final String TOP_CHAT = "top_chat";

        /* record the unread count */
    ...
    private static final String CREATE_CONVERSATIONS_TABLE_SQL =
            "CREATE TABLE " + CONVERSATIONS_TABLE + "("
                    ...
                    + ConversationColumns.TOP_CHAT + " INT DEFAULT(0) ,"
                    + ConversationColumns.UNREAD_COUNT + " INT DEFAULT(0) "
                    + ");";
    ...
    private static final String CREATE_MESSAGES_TABLE_SQL =
            "CREATE TABLE " + MESSAGES_TABLE + " ("
                    ...
                    + MessageColumns.FAVORITES + " INT DEFAULT(0), "
    ...
    public static class FavoritesColumns implements BaseColumns {
        ...
        public static final String FAVORITES_SAVED_TIME = "favorites_saved_time";
        ...
        public static final String PARTICIPANT_CONTACT_ID = ConversationColumns.PARTICIPANT_CONTACT_ID;

        public static final String PARTICIPANT_LOOKUP_KEY = ConversationColumns.PARTICIPANT_LOOKUP_KEY;
    }

    private static final String CREATE_FAVORITES_TABLE_SQL =
            "CREATE TABLE " + FAVORITES_TABLE + "("
                    + FavoritesColumns.FAVORITES_ID + " INTEGER PRIMARY KEY AUTOINCREMENT,"
                    + FavoritesColumns.MESSAGE_ID + " INT,"
                    + FavoritesColumns.PROFILE_PHOTO_URI + " TEXT, "
                    + FavoritesColumns.FULL_NAME + " TEXT, "
                    + FavoritesColumns.SEND_DESTINATION + " TEXT, "
                    + FavoritesColumns.SENT_TIMESTAMP + " INT DEFAULT(0), "
                    + FavoritesColumns.RECEIVED_TIMESTAMP + " INT DEFAULT(0), "
                    + FavoritesColumns.FAVORITES_SAVED_TIME + " INT DEFAULT(0), "
                    + FavoritesColumns.SUB_ID + " INT DEFAULT("
                    + ParticipantData.OTHER_THAN_SELF_SUB_ID + "),"
                    + FavoritesColumns.SIM_SLOT_ID + " INT DEFAULT("
                    + ParticipantData.INVALID_SLOT_ID + "),"
                    + FavoritesColumns.CONTENT + " TEXT, "
                    + FavoritesColumns.CONVERSATION_ID + " INT, "
                    + FavoritesColumns.PARTICIPANT_CONTACT_ID + " INT DEFAULT ( "
                    + ParticipantData.PARTICIPANT_CONTACT_ID_NOT_RESOLVED + "), "
                    + FavoritesColumns.PARTICIPANT_LOOKUP_KEY + " TEXT" +")";
    ...
    private static final String[] CREATE_VIEW_SQLS = new String[] {
        ...
        ConversationListItemData.getSearchListViewSql(),
