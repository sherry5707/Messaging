...
public class DataModelImpl extends DataModel {
    ...
    @Override
    public FavoritesData createFavoritesData(final Context context,
                                             final FavoritesData.FavoritesListDataListener listener) {
        return new FavoritesData(context, listener);
    }
