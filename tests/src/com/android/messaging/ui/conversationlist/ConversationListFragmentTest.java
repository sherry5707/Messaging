    ...
    private void loadWith(final Cursor cursor) {
        ...
        getActivity().runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                FavoritesData favoritesData = FavoritesData.getLastFavorite(DataModel.get().getDatabase());
                fragment.onConversationListCursorUpdated(mMockConversationListData, cursor, favoritesData);
            }
        });
